...
public class AnnotationParseException extends Exception {
    ...
    public AnnotationParseException(String annotationText, String message, Throwable cause) {
        super(formatMessage(annotationText, message), cause);
    }

    private static String formatMessage(String annotationText, String errorMessage) {
        return String.format("Could not parse annotation.\n Reason: [%s]\nAnnotation text: [%s]", errorMessage,
                annotationText);
    }
}
