...
//                    "/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta-benchmark/GH_Q1/queries/q1_" + power + ".jq",
//                    "null",
//                    Collections.singletonList("/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta_benchmark_data/bigghTables/bigghTable" + power),
//                    Collections.singletonList("/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta-benchmark/createTables/create_table_" + power + ".jq"),
...
//            benchmarkFiles.add(new FileTuple(
//                    "null",
//                    queryFirstHalf + "/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta_benchmark_data/bigghTables/bigghTable" + power + queryLastHalf,
//                    Collections.singletonList("/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta_benchmark_data/bigghTables/bigghTable" + power),
//                    Collections.singletonList("/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta-benchmark/GH_Q1/createTables/create_table_" + power +".jq"),
...
//                    "null",
//                    (tables) -> {
//                        String updateSchemaQuery = "ALTER TABLE delta.`" + tables.get(0) + "` ADD COLUMNS (repo.nickname STRING, repo.popularity_rating INT)";
//                        String setQuery = "UPDATE delta.`" + tables.get(0) +"` SET repo.nickname = 'cool_nickname', repo.popularity_rating = -1;";
...
//                    "null",
//                    (tables) -> {
//                        String insertSchemaQuery = "ALTER TABLE delta.`" + tables.get(0) + "` ADD COLUMNS (ids ARRAY<STRUCT<repo_id : STRING, actor_id : STRING, id : STRING>>)";
//                        String setQuery = "UPDATE delta.`" + tables.get(0) +"` SET ids = array(named_struct('repo_id', repo.id, 'actor_id', actor.id, 'id', id)), repo.id = NULL, actor.id = NULL, id = NULL;";
...
//         RUMBLE
        for (Integer power : powersOf2) {
            benchmarkFiles.add(new FileTuple(
                    "/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta-benchmark/new_order_trans/update_new_order_" + power + ".jq",
                    "null",
                    Collections.singletonList("/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta_benchmark_data/newOrderTable" + power),
                    Collections.singletonList("/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta-benchmark/new_order_trans/create_new_order_table_" + power + ".jq"),
                    "/home/davidl/Documents/Thesis/rumble/BenchmarkResults/NEW_ORDER_TRANS/RUMBLE_NEW_ORDER_INC_" + power + ".txt",
                    false
            ));
        }
...
//         SPARK
        for (Integer power : powersOf2) {
            benchmarkFiles.add(new FileTuple(
                    ...
                    Collections.singletonList("/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta_benchmark_data/newOrderTable" + power),
                    Collections.singletonList("/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta-benchmark/new_order_trans/create_new_order_table_" + power + ".jq"),
                    "/home/davidl/Documents/Thesis/rumble/BenchmarkResults/NEW_ORDER_TRANS/SPARK_NEW_ORDER_INC_" + power + ".txt",
                    true
            ));
        }
//        benchmarkFiles.add(new FileTuple(
//                null,
//                (tables) -> {
//                    String query = "WITH updates AS ( SELECT S_I_ID, OL_QUANTITY FROM delta.`" + tables.get(0) +"` JOIN delta.`" + tables.get(1) + "` ON S_I_ID = OL_I_ID AND S_W_ID = OL_SUPPLY_W_ID )" +
//                            " MERGE INTO delta.`" + tables.get(0) + "` USING updates" +
//                            " ON delta.`" + tables.get(0) + "`.S_I_ID = updates.S_I_ID " +
//                            "WHEN MATCHED THEN UPDATE SET S_QUANTITY = CASE WHEN S_QUANTITY - OL_QUANTITY >= 10 THEN S_QUANTITY - OL_QUANTITY ELSE S_QUANTITY - OL_QUANTITY + 91," +
//                            " S_YTD = S_YTD + OL_QUANTITY, S_ORDER_CNT = S_ORDER_CNT + 1";
//                    SparkSessionManager.getInstance().getOrCreateSession().sql(query);
//                },
//                Arrays.asList("/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta_benchmark_data/stockTable32", "/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta_benchmark_data/orderLineTable"),
//                Arrays.asList("/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta-benchmark/new_order_trans/create_stock_table_32.jq", "/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta-benchmark/new_order_trans/create_order_line_table.jq"),
...
//        for (Integer power : powersOf2) {
//            benchmarkFiles.add(new FileTuple(
//                    "/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta-benchmark/payment_trans/payment" + power + ".jq",
//                    "null",
//                    Collections.singletonList("/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta_benchmark_data/customerTable" + power),
//                    Collections.singletonList("/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta-benchmark/payment_trans/create_customer_table_" + power + ".jq"),
...
//                    (tables) -> {
//                        int h_amt = 343;
//                        String query = "UPDATE delta.`" + tables.get(0) +"` SET C_BALANCE = (C_BALANCE + " + h_amt + "), C_DATA = if(C_CREDIT == 'BC', concat(C_DATA, C_ID, C_D_ID, C_W_ID, " + h_amt + "), C_DATA);";
//                        SparkSessionManager.getInstance().getOrCreateSession().sql(query);
//                    },
//                    Collections.singletonList("/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta_benchmark_data/customerTable" + power),
//                    Collections.singletonList("/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta-benchmark/payment_trans/create_customer_table_" + power + ".jq"),
...
//        for (Integer power : powersOf2) {
//            benchmarkFiles.add(new FileTuple(
//                    "/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta-benchmark/delivery_trans/delivery" + power + ".jq",
//                    "null",
//                    Arrays.asList(
...
//                    ),
//                    Arrays.asList(
//                            "/home/davidl/Documents/Thesis/rumble/src/test/resources/queries/delta-benchmark/delivery_trans/create_customer_table_" + power + ".jq",
...
//                    ),
//                    "/home/davidl/Documents/Thesis/rumble/BenchmarkResults/DELIVERY_TRANS/RUMBLE_CUSTOMER_JOIN_" + power + ".txt",
//                    false
//            ));
//        }
//
...
//                                "SELECT D_ID, SUM(OL_AMOUNT) AS OL_TOTAL FROM delta.`" + tables.get(1) + "` JOIN delta.`" + tables.get(2) + "` ON D_ID = OL_D_ID" +
...
//        sparkConfiguration.set("spark.submit.deployMode", "client");
    ...
    public void benchmarkDelta(String queryPath, List<String> tablePaths, List<String> createTablePaths, String outputPath) throws IOException {
        long total = 0;
    ...
    public void benchmarkSpark(String query, List<String> tablePaths, List<String> createTablePaths, String outputPath, Optional<Consumer<List<String>>> possSqlFunc) throws IOException {
        long total = 0;
        long[] diffs = new long[10];
        long start;
        long end;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (FileTuple ft : benchmark.benchmarkFiles) {
            if (ft.isSQL()) {
                benchmark.benchmarkSpark(ft.getQueryMaterial(), ft.getTablePaths(), ft.getCreateTablePaths(), ft.getOutputPath(), Optional.ofNullable(ft.getSqlQueryFunc()));
            } else {
                benchmark.benchmarkDelta(ft.getQueryMaterial(), ft.getTablePaths(), ft.getCreateTablePaths(), ft.getOutputPath());
            }
        }
    ...
    class FileTuple {
        ...
        public FileTuple(String queryPath, String sqlQuery, List<String> tablePaths, List<String> createTablePaths, String outputPath, boolean isSQL) {
        ...
        public FileTuple(String queryPath, Consumer<List<String>> sqlQueryFunc, List<String> tablePaths, List<String> createTablePaths, String outputPath, boolean isSQL) {
            this.queryPath = queryPath;
            this.sqlQuery = null;
