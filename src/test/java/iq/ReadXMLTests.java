...
// TODO CHECK IF THIS CAN BE USED FOR NEW TESTS AND DELETE AS IT SEEMS TO BE UNUSED
public class ReadXMLTests extends AnnotationsTestsBase {/*
                                                         ...
                                                         * }
                                                         * 
                                                         * private MainModule parseAndCompile(String filePath) throws
                                                         * IOException {
                                                         ...
                                                         * }
                                                         * 
                                                         * private PathExpr getPathExprFromMainModule(String filePath)
                                                         * throws IOException {
                                                         * MainModule mainModule = parseAndCompile(filePath);
                                                         * Program program = (Program)
                                                         * mainModule.getDescendantsMatching(stmt -> stmt instanceof
                                                         * Program).get(0);
                                                         * return (PathExpr)
                                                         * program.getStatementsAndOptionalExpr().getExpression();
                                                         * }
                                                         * 
                                                         * @Test(timeout = 100000)
                                                         * public void testBlockStatementWithSequentialStatement()
                                                         * throws Throwable {
                                                         ...
                                                         * List<Item> children =
                                                         * documentNode.children().get(0).children();
                                                         ...
                                                         * String content1 =
                                                         * elementNode1.stringValue().trim().replaceAll("(?<=\\n)\\s+",
                                                         * "");
                                                         * String content2 =
                                                         * elementNode2.stringValue().trim().replaceAll("(?<=\\n)\\s+",
                                                         * "");;
                                                         * String content3 =
                                                         * elementNode3.stringValue().trim().replaceAll("(?<=\\n)\\s+",
                                                         * "");;
                                                         * String content4 =
                                                         * elementNode4.stringValue().trim().replaceAll("(?<=\\n)\\s+",
                                                         * "");;
                                                         ...
                                                         * 
                                                         * @Test(timeout = 100000)
                                                         * public void testPathConstructionWithStartingDash() throws
                                                         * Throwable {
                                                         * String filePath = System.getProperty("user.dir")
                                                         * +
                                                         ...
                                                         * 
                                                         * @Test(timeout = 100000)
                                                         * public void testPathConstructionWithoutStartingDash() throws
                                                         * Throwable {
                                                         * String filePath = System.getProperty("user.dir")
                                                         * +
                                                         ...
                                                         * 
                                                         * @Test(timeout = 100000)
                                                         * public void testPathConstructionWithPredicates() throws
                                                         * Throwable {
                                                         * String filePath = System.getProperty("user.dir")
                                                         * +
                                                         ...
                                                         * res = res.replaceAll("[,#]", "");
                                                         * assertEquals(
                                                         * "/child::book/child::chapter[(fn:position0())=(5)]/child::section[(fn:position0())=(2)]",
                                                         * res);
                                                         * }
                                                         * 
                                                         * @Test(timeout = 100000)
                                                         * public void testPathConstructionWithDoubleSlashStart() throws
                                                         * Throwable {
                                                         * String filePath = System.getProperty("user.dir")
                                                         * +
                                                         ...
                                                         * res = res.replaceAll("[,#]", "");
                                                         * assertEquals(
                                                         * "/descendant-or-self::node()/child::book/child::chapter[5]/child::section[2]",
                                                         * res);
                                                         * }
                                                         * 
                                                         * @Test(timeout = 100000)
                                                         * public void testPathConstructionWithOrOperation() throws
                                                         * Throwable {
                                                         * String filePath = System.getProperty("user.dir")
                                                         * +
                                                         ...
                                                         * res = res.replaceAll("[,#]", "");
                                                         * assertEquals(
                                                         * "child::book/(child::chapter)or(child::appendix)/descendant-or-self::node()/child::section",
                                                         * res);
                                                         * }
                                                         * 
                                                         * @Test(timeout = 100000)
                                                         * public void testPathConstructionWithDoubleSlashes() throws
                                                         * Throwable {
                                                         * String filePath = System.getProperty("user.dir")
                                                         * +
                                                         ...
                                                         * 
                                                         * @Test(timeout = 100000)
                                                         * public void testPathConstructionWithWildcard() throws
                                                         * Throwable {
                                                         * String filePath = System.getProperty("user.dir")
                                                         * +
                                                         ...
                                                         * 
                                                         * @Test(timeout = 100000)
                                                         * public void testPathConstructionWithWildcardReverseAxis()
                                                         * throws Throwable {
                                                         * String filePath = System.getProperty("user.dir")
                                                         * +
                                                         ...
                                                         * 
                                                         * @Test(timeout = 100000)
                                                         * public void testPathConstructionWithWildcardMultiPath()
                                                         * throws Throwable {
                                                         * String filePath = System.getProperty("user.dir")
                                                         * +
                                                         ...
                                                         * 
                                                         * @Test(timeout = 100000)
                                                         * public void testPathConstructionWithAttributeTest() throws
                                                         * Throwable {
                                                         * String filePath = System.getProperty("user.dir")
                                                         * +
                                                         ...
                                                         * 
                                                         * @Test(timeout = 100000)
                                                         * public void testPathConstructionWithReverseAxis() throws
                                                         * Throwable {
                                                         * String filePath = System.getProperty("user.dir")
                                                         * +
                                                         ...
                                                         * 
                                                         * @Test(timeout = 100000)
                                                         * public void testPathConstructionWithReverseAxisAbbreviated()
                                                         * throws Throwable {
                                                         * String filePath = System.getProperty("user.dir")
                                                         * +
                                                         ...
                                                         * 
                                                         * @Test(timeout = 100000)
                                                         * public void testPathConstructionWithReverseAxisMultiPath()
                                                         * throws Throwable {
                                                         * String filePath = System.getProperty("user.dir")
                                                         * +
                                                         ...
                                                         * res = res.replaceAll("[,#]", "");
                                                         * assertEquals(
                                                         * "ancestor-or-self::di/ancestor::p/parent::text()", res);
                                                         * }
                                                         */
}
