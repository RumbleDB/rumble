...
public class KryoFieldSerializationTest {
    ...
    public void configurationRoundTripsWithFieldSerializer() {
        ...
        Assertions.assertEquals(
                configuration.output().outputPath(), copy.output().outputPath());
        Assertions.assertEquals(
    ...
    public void polymorphicBindingsRoundTripWithFieldSerializer() {
        ...
        bindings.bind(Name.createVariableInNoNamespace("file"), new FileBinding("input.txt", InputFormat.TEXT));
        bindings.bind(Name.createVariableInNoNamespace("stdin"), new StandardInputBinding(InputFormat.JSON));
        bindings.bind(
