(:JIQS: ShouldRun; Output="({ "name" : "A", "stores" : [ ] }, { "name" : "B", "stores" : [ ] }, { "name" : "C", "stores" : [ 1 ] }, { "name" : "C", "stores" : [ 2 ] }, { "name" : "C", "stores" : [ 3 ] })" :)
...
return
  for $nation in $nations[], $store allowing empty in $stores[][ $nation.p eq  last() ] 
