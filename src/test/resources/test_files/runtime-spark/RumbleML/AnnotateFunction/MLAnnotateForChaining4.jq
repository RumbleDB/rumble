(:JIQS: ShouldRun; Output="({ "age" : 20, "id" : 1, "weight" : 68.8, "binarized_weight" : 0, "features" : [ 0 ], "prediction" : 1 }, { "age" : 35, "id" : 2, "weight" : 72.4, "binarized_weight" : 1, "features" : [ 1 ], "prediction" : 0 }, { "age" : 50, "id" : 3, "weight" : 76.3, "binarized_weight" : 1, "features" : [ 1 ], "prediction" : 0 })" :)
