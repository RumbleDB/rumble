...
(
    ...
    (: Because we are validating against the t:Record type, t:value is treated as a t:Record, and t:amount is treated as a t:Count based on the schema. :)
    ...
    data((validate strict { <t:root><t:amount>42</t:amount></t:root> })/t:amount)
        instance of t:Count,
    (: Lax validation tolerates the undeclared root but still validates the globally declared child as t:Count. :)
    data((validate lax {
