(:JIQS: ShouldRun; Output="({ "foo" : "foo", "bar" : "foobar", "int" : 42 }, { "foo" : "foo", "bar" : "def", "int" : 42 }, { "foo" : "foo", "bar" : "foobar", "int" : 42 }, { "foo" : "foo", "bar" : "def", "int" : 42 }, { "foo" : "foo", "bar" : "def", "int" : 42 }, { "foo" : "foo", "bar" : "def", "int" : 42 })" :)
...
validate type local:a* { { "foo" : "foo", "bar" : "foobar" } },
validate type local:a* { { "foo" : "foo" } },
validate type local:a* { parallelize({ "foo" : "foo", "bar" : "foobar" }) },
validate type local:a* { parallelize({ "foo" : "foo" }) },
validate type local:a* { validate type local:c* { { "foo" : "foo" } } },
