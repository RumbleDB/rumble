(:JIQS: ShouldRun; Output="({ "foo" : "foo", "bar" : "foobar", "int" : 1 }, { "foo" : "foo", "bar" : "def", "int" : 42 }, { "foo" : "foo", "bar" : "foobar", "int" : 42 }, { "foo" : "foo", "bar" : "def", "int" : 42 }, { "bar" : "foobar", "foo" : "foo", "int" : 42 }, { "foo" : "foo", "bar" : "def", "int" : 42 }, { "bar" : "def", "int" : 42, "foo" : "foo" }, { "bar" : "foobar", "int" : 42, "foo" : "foo" }, { "bar" : "def", "int" : 42, "foo" : "foo" }, { "bar" : "foobar", "int" : 42, "foo" : "foo" }
)" :)
