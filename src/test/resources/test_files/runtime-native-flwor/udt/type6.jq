(:JIQS: ShouldRun; Output="({ "foo" : 1 }, { "foo" : 300 }, { }, true, true, true, true, true, true, Success, Success, Success, { "foo" : [ 2 ] }, { "foo" : [ 3, 4 ] }, { }, Success, Success, 1000000, { "foo" : [ 2 ] }, { "foo" : [ 3, 4 ] }, Success, Success)" :)
...
declare type local:w as { "foo" : "unsignedByte", "bar" : "unsignedLong" };
