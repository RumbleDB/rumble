(:JIQS: ShouldRun; Output="({ "foo" : 2 }, { }, { "foo" : 2 }, Success, Success, true, true, true, true, true, true, true, true, true, true, true, Success, Success, Success, Success, Success, Success, { "foo" : [ 2 ] }, { "foo" : [ 3, 4 ] }, { }, Success, Success, Success, { "foo" : [ 2 ] }, Success, Success, Success, Success)" :)
