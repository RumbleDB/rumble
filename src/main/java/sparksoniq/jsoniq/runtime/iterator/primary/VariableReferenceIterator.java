...
public class VariableReferenceIterator extends HybridRuntimeIterator {
    ...
    public JavaRDD<Item> getRDDAux(DynamicContext context) {
        return _currentDynamicContextForLocalExecution.getRDDVariableValue(_variableName, getMetadata());
    }

    @Override
    public Dataset<Row> getDataFrame(DynamicContext context) {
        return _currentDynamicContextForLocalExecution.getDFVariableValue(_variableName, getMetadata());
    }
