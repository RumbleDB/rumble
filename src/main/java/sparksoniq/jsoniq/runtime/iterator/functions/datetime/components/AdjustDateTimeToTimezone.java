        ...
        if (this._hasNext) {
            ...
            if (this._timezone == null && this._children.size() == 1)
                return ItemFactory.getInstance()
                    .createDateTimeItem(this._timeItem.getDateTimeValue().withZone(DateTimeZone.UTC), true);
            if (this._timezone == null) {
                ...
                return ItemFactory.getInstance()
                    .createDateTimeItem(this._timeItem.getDateTimeValue(), this._timeItem.hasTimeZone());
            } else {
