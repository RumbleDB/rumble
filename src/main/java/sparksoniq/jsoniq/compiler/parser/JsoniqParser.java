...
public class JsoniqParser extends Parser {
    ...
    public static class CatchClauseContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JsoniqVisitor)
                return ((JsoniqVisitor<? extends T>) visitor).visitCatchClause(this);
            else
                return visitor.visitChildren(this);
        }
    }
                    ...
                    {
                        {
                            ...
                            switch (_input.LA(1)) {
                                ...
                                case STRING: {
                                    setState(582);
                                    ((CatchClauseContext) _localctx).stringLiteral = stringLiteral();
                                    ((CatchClauseContext) _localctx).errors.add(
                                        ((CatchClauseContext) _localctx).stringLiteral
                                    );
                                }
                                    break;
                                default:
                        ...
                        {
                            {
                                ...
                                if (!(_la == T__45 || _la == T__46)) {
                                    ((AdditiveExprContext) _localctx)._tset1195 = (Token) _errHandler.recoverInline(
                                        this
                                    );
                                } else {
                                    if (_input.LA(1) == Token.EOF)
                    ...
                    {
                        {
                            ...
                            if (
                                ...
                                ((MultiplicativeExprContext) _localctx)._tset1223 = (Token) _errHandler.recoverInline(
                                    this
                                );
                            } else {
                                if (_input.LA(1) == Token.EOF)
                            ...
                            ((MultiplicativeExprContext) _localctx).op.add(
                                ((MultiplicativeExprContext) _localctx)._tset1223
                            );
                            setState(643);
