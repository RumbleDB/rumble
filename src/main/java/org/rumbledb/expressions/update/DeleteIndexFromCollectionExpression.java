...
public class DeleteIndexFromCollectionExpression extends Expression {
    ...
    public DeleteIndexFromCollectionExpression(
        ...
        // TODO: The current implementations only accounts for two callening modes- table, and
        // delta-file
    ...
    public List<Node> getChildren() {
        return this.numDelete == null
                ? Arrays.asList(this.collection)
                : Arrays.asList(this.collection, this.numDelete);
    }
