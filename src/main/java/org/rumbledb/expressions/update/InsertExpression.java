...
public class InsertExpression extends Expression {
    ...
    @Getter private final Expression mainExpression;
    @Getter private final Expression toInsertExpression;
    ...
    public List<Node> getChildren() {
        return this.positionExpression == null
                ...
                : Arrays.asList(
                        this.mainExpression, this.toInsertExpression, this.positionExpression);
    }
