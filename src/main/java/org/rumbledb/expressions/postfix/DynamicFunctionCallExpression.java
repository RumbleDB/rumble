...
public class DynamicFunctionCallExpression extends Expression {
    ...
    /**
     * DynamicFunctionCall is always locally evaluated as execution mode cannot be determined at
     * static analysis phase. This behavior is different from all other postfix extensions, hence no
