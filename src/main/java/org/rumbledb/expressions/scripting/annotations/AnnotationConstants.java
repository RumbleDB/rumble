...
public class AnnotationConstants {
    ...
    public static final Name NON_SEQUENTIAL =
            new Name(Name.JSONIQ_ANNOTATIONS_NS, "an", "nonsequential");
    ...
    public static final Name NON_ASSIGNABLE =
            new Name(Name.JSONIQ_ANNOTATIONS_NS, "an", "nonassignable");
}
