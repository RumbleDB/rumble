 ...
 *
 * <p>All document node constructors are computed constructors.
 *
 * <p>The result of a document node constructor is a new document node, with its own node identity.
 *
 * @see <a href="https://www.w3.org/TR/xquery-31/#id-documentConstructors">XQuery 3.1, 3.9.3.3:
 *     Document Node Constructors</a>
 */
@Getter
