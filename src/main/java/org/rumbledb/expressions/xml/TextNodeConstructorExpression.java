 ...
 *
 * <p>All text node constructors are computed constructors. The result of a text node constructor is
 * a new text node, with its own node identity.
 *
 * <p>Syntax: text { content }
 *
 * @see <a href="https://www.w3.org/TR/xquery-31/#id-textConstructors">XQuery 3.1, 3.9.3.4: Text
 *     Node Constructors</a>
 */
@Getter
