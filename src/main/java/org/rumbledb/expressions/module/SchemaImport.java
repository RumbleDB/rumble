...
/** An XQuery schema import declaration whose location hints have not yet been resolved. */
@Getter
    ...
    public SchemaImport(
        ...
        if ((bindingKind == BindingKind.PREFIX) != (prefix != null)) {
            throw new OurBadException(
                    "A prefixed schema import must have a prefix, and other schema imports must not have one.");
        }
