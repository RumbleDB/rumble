...
/**
 * Derives query-wide configuration adjustments from the AST without mutating the user
 * configuration.
 */
public class EffectiveConfigurationVisitor
        extends AbstractNodeVisitor<RumbleConfiguration.RumbleConfigurationBuilder> {
    ...
    private static void disableParentPointerOptimization(
            RumbleConfiguration.RumbleConfigurationBuilder builder) {
