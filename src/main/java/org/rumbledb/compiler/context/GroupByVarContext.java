...
public record GroupByVarContext<
    ...
    public static GroupByVarContext<
            ...
            from(JsoniqParser.GroupByVarContext c) {
        return new GroupByVarContext<>(c.var_ref, c.seq, c.ex, c.uriLiteral(), c);
    }
    ...
    public static GroupByVarContext<
            ...
            from(XQueryParser.GroupByVarContext c) {
        return new GroupByVarContext<>(c.var_ref, c.seq, c.ex, c.uriLiteral(), c);
    }
}
