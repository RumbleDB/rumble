...
public record SingleTypeCheckExprContext<
        MainExprCtx extends ParserRuleContext, SingleTypeCtx extends ParserRuleContext>(
        MainExprCtx mainExpr, SingleTypeCtx single, ParserRuleContext context) {
