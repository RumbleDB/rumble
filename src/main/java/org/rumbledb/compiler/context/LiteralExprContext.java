...
public record LiteralExprContext<S extends ParserRuleContext>(
    ...
    public static LiteralExprContext<JsoniqParser.StringLiteralContext> from(JsoniqParser.LiteralContext c) {
        if (c.stringLiteral() != null) {
            return new LiteralExprContext<>(c.stringLiteral(), null, c);
        }
        String text = c.numericLiteral() != null ? c.numericLiteral().getText() : c.getText();
        return new LiteralExprContext<>(null, text, c);
    }

    public static LiteralExprContext<XQueryParser.StringLiteralContext> from(XQueryParser.LiteralContext c) {
        if (c.stringLiteral() != null) {
            return new LiteralExprContext<>(c.stringLiteral(), null, c);
        }
        String text = c.numericLiteral() != null ? c.numericLiteral().getText() : c.getText();
