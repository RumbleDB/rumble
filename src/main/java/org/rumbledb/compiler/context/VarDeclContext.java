...
public record VarDeclContext<
        ...
        VarBindingCtx varBinding,
        SeqTypeCtx sequenceType,
        ExprSingleCtx exprSingle,
        boolean isExternal) {

    public static VarDeclContext<
            ...
            from(JsoniqParser.VarDeclContext ctx) {
        return new VarDeclContext<>(
                ctx, ctx.annotations(), ctx.varBinding(), ctx.sequenceType(), ctx.exprSingle(), ctx.external != null);
    }
    ...
    public static VarDeclContext<
            ...
            from(XQueryParser.VarDeclContext ctx) {
        return new VarDeclContext<>(
                ctx, ctx.annotations(), ctx.varBinding(), ctx.sequenceType(), ctx.exprSingle(), ctx.external != null);
    }
}
