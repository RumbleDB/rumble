...
public class VisitorConfig {
     ...
     */
    static final VisitorConfig executionModeInitialPassConfig = new VisitorConfig.Builder()
     ...
     */
    static final VisitorConfig executionModeIntermediatePassConfig = new VisitorConfig.Builder()
     ...
     */
    static final VisitorConfig executionModeFinalPassConfig = new VisitorConfig.Builder()
            .withsuppressErrorsForFunctionSignatureCollision(true)
            .withSuppressErrorsForCallingMissingFunctions(false)
