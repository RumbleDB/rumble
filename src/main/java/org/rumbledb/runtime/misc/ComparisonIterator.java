        ...
        if (this.comparisonOperator.isValueComparison()) {
            ...
            if (
                SequenceType.Arity.OneOrMore.isSubtypeOf(this.leftIterator.getStaticType().getArity())
                    ||
                    SequenceType.Arity.OneOrMore.isSubtypeOf(this.rightIterator.getStaticType().getArity())
            ) {
                return NativeClauseContext.NoNativeQuery;
            }
            ...
            if (
                !(this.leftIterator.getStaticType() != null
                    && this.rightIterator.getStaticType() != null
                    && this.leftIterator.getStaticType().getItemType().isNumeric()
                    && this.rightIterator.getStaticType().getItemType().isNumeric()
                    || this.leftIterator.getStaticType()
                        .getItemType()
                        .equals(this.rightIterator.getStaticType().getItemType()))
            ) {
                return NativeClauseContext.NoNativeQuery;
            }
