...
public class CreateCollectionPrimitive implements UpdatePrimitive {
    ...
    public void applyDelta() {
        this.contents =
                this.contents.withColumn(
                        SparkSessionManager.rowIdColumnName, monotonically_increasing_id());
            ...
            switch (this.collection.getMode()) {
                ...
                default:
                    throw new UnsupportedOperationException(
                            "Create Collection: Unsupported collection mode: "
                                    + this.collection.getMode());
            }
