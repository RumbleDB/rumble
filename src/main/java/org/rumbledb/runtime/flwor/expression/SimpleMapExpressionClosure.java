...
// can be used if the zipping with position is not needed as optimization, similar to
// PredicateIterator
public class SimpleMapExpressionClosure implements FlatMapFunction<Item, Item> {
    ...
    public SimpleMapExpressionClosure(
            RuntimeIterator rightIterator, DynamicContext dynamicContext) {
