...
public class ReturnClauseSparkIterator extends HybridRuntimeIterator {
    ...
    public ReturnClauseSparkIterator(
        ...
        this(child, expression, false, executionMode, iteratorMetadata, sequenceType);
    }
    ...
    public PendingUpdateList getPendingUpdateList(DynamicContext context) {
        ...
        if (!isRDDOrDataFrame()) {
            ...
            while (this.child.hasNext()) {
                ...
                result = PendingUpdateList.mergeUpdates(result, this.expression.getPendingUpdateList(this.tupleContext));
        ...
        if (expression.isRDDOrDataFrame()) {
            ...
            while (this.child.hasNext()) {
                ...
                result = PendingUpdateList.mergeUpdates(result, intermediateResult);
            }
        }
        return result;
    }
