...
public final class FormatIntegerPictureParser {
    ...
    public static FormatIntegerPicture parse(String pictureString, ExceptionMetadata metadata) {
        ...
        IntegerFormatModifier formatModifier =
                parseFormatModifier(formatModifierString, pictureString, metadata);
    ...
    public static PrimaryFormatToken parsePrimaryFormatToken(
        ...
        if (containsDecimalDigit(primaryFormatTokenString)) {
            NumericPicture numericPicture =
                    NumericPictureParser.parseForInteger(
                            primaryFormatTokenString, pictureStringForErrors, metadata);
