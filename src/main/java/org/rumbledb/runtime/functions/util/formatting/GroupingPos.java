...
/**
 * @param distanceFromAnchor Digit signs between the separator and the edge grouping is measured
 *     from: the right for an integer part, the left for a fractional part.
 */
