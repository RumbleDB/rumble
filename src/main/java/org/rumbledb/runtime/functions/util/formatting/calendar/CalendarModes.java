...
public final class CalendarModes {
    ...
    private static final Map<String, String> ICU_TYPES =
            Map.ofEntries(
    ...
    private static final Set<String> KNOWN_DESIGNATORS =
            Set.of(
                    "AD", "AH", "AME", "AM", "AP", "AS", "BE", "CB", "CE", "CL", "CS", "EE", "FE",
                    "ISO", "JE", "KE", "KY", "ME", "MS", "NS", "OS", "RS", "SE", "SH", "SS", "TE",
                    "VE", "VS");
