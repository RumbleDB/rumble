...
public final class DateNames {
    ...
    private static final Map<SymbolsKey, DateFormatSymbols> SYMBOLS_CACHE =
            new ConcurrentHashMap<>();

    private DateNames() {}

    public static String monthName(
            OffsetDateTime value, FormattingContext context, int min, int max) {
        Calendar cal = CalendarFields.calendar(value, context);
        DateFormatSymbols symbols = symbolsFor(cal, context.uLocale);
        int month =
                CalendarFields.usesJavaTimeFields(context)
    ...
    private static String monthName(DateFormatSymbols symbols, int month, int min, int max) {
        ...
        String abbr =
                symbols.getMonths(DateFormatSymbols.FORMAT, DateFormatSymbols.ABBREVIATED)[month];
        String narrow =
                symbols.getMonths(DateFormatSymbols.FORMAT, DateFormatSymbols.NARROW)[month];
    ...
    private static String dayName(DateFormatSymbols symbols, int day, int min, int max) {
        ...
        String abbr =
                symbols.getWeekdays(DateFormatSymbols.FORMAT, DateFormatSymbols.ABBREVIATED)[day];
        String narrow =
                symbols.getWeekdays(DateFormatSymbols.FORMAT, DateFormatSymbols.NARROW)[day];
