...
public class BuiltinFunctionItemCallIterator extends ItemRuntimePlan
    ...
    public BuiltinFunctionItemCallIterator(
            Item functionItem, List<ItemRuntimePlan> functionArguments, RuntimeStaticContext staticContext) {
        super(
        ...
        FunctionCallArgumentConversion.wrapAccordingToSignature(functionItem, this.functionArguments, staticContext);
    }
    ...
    private ItemRuntimePlan getPlan() {
        return NamedFunctions.getBuiltInFunctionIterator(
                this.functionItem.getIdentifier(), new ArrayList<>(this.functionArguments), this.staticContext, true);
    }
