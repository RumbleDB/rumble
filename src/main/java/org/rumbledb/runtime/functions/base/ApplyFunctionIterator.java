...
public class ApplyFunctionIterator extends ItemRuntimePlan
    ...
    public ApplyFunctionIterator(List<ItemRuntimePlan> arguments, RuntimeStaticContext staticContext) {
    ...
    public HomogeneousItemDataFrame createNativeDataFrame(DynamicContext context) {
        return ItemRuntimeDataFrameFactory.INSTANCE.fromPlan(this.buildPlan(context), context);
    }
    ...
    private ItemRuntimePlan buildPlan(DynamicContext context) {
        ...
        RuntimeStaticContext localItemStarContext = this.staticContext.toBuilder()
        ...
        ItemRuntimePlan functionItemIterator = new ConstantRuntimeIterator(
                ...
                this.staticContext.toBuilder()
                        ...
                        .executionMode(ExecutionMode.LOCAL)
                        .build());
        return new DynamicFunctionCallIterator(functionItemIterator, argumentIterators, this.staticContext);
    }
    ...
    private static ItemRuntimePlan buildArgumentIterator(
        ...
        List<ItemRuntimePlan> sequenceItems = new ArrayList<>(memberSequence.size());
