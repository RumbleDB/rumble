...
public class FunctionUntypedAtomicCastIterator extends ItemRuntimePlan
    ...
    public Cursor<Item> createNativeCursor(DynamicContext context) {
        return new MappingLocalCursor<>(this.iterator, context, this.caster::call, getMetadata());
    }

    @Override
    public HomogeneousItemDataFrame createNativeDataFrame(DynamicContext dynamicContext) {
        return ItemRuntimeDataFrameFactory.INSTANCE.fromPlan(this.iterator, dynamicContext);
    }
    ...
    public static final class UntypedAtomicCaster implements Function<Item, Item> {
        ...
        public Item call(Item item) {
            ...
            Item converted = CastIterator.castItemToType(item, this.targetType, this.metadata, this.staticContext);
            if (converted == null) {
