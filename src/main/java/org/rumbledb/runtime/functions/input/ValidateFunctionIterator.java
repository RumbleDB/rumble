...
public class ValidateFunctionIterator extends LocalFunctionCallIterator {

    public ValidateFunctionIterator(
    ...
    public Item next() {
        if (this.hasNext) {
            ...
            try {
                ...
                return ItemFactory.getInstance().createBooleanItem(schema.validateInstance(instance.serialize()));
            } catch (IOException e) {
