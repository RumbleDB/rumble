...
public class JsonDocFunctionIterator extends AtMostOneItemLocalRuntimeIterator {
    ...
    private static URI resolveJsonDocURI(
            String href, URI staticBaseUri, ExceptionMetadata metadata) {
        try {
    ...
    private static String decode(byte[] bytes, Charset charset, ExceptionMetadata metadata) {
        try {
            ...
            CannotInferEncodingException ex =
                    new CannotInferEncodingException(
