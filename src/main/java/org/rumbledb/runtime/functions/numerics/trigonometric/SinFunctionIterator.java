...
public class SinFunctionIterator extends AbstractAtMostOneItemRuntimePlan implements NativeQueryRuntimePlan {
    ...
    public SinFunctionIterator(List<ItemRuntimePlan> arguments, RuntimeStaticContext staticContext) {
    ...
    public NativeClauseContext generateNativeQuery(NativeClauseContext nativeClauseContext) {
        ...
        String resultingQuery = "SIN( " + childQuery.getResultingQuery() + " )";
