...
public class LogFunctionIterator extends AbstractAtMostOneItemRuntimePlan implements NativeQueryRuntimePlan {
    ...
    public LogFunctionIterator(List<ItemRuntimePlan> arguments, RuntimeStaticContext staticContext) {
    ...
    private static Item evaluate(Item value) {
        return ItemFactory.getInstance().createDoubleItem(Math.log(value.getDoubleValue()));
    }
    ...
    public NativeClauseContext generateNativeQuery(NativeClauseContext nativeClauseContext) {
        ...
        String resultingQuery = "LN( " + childQuery.getResultingQuery() + " )";
