...
public class DirElemConstructorRuntimeIterator extends AtMostOneItemLocalRuntimeIterator {
    ...
    public Item materializeFirstItemOrNull(DynamicContext dynamicContext) {
        ...
        if (this.content != null) {
            ...
            for (RuntimeIterator iterator : this.content) {
                ...
                while (iterator.hasNext()) {
                    ...
                    for (Item item : expandedItems) {
                        ...
                        // both proper text nodes, or any non-node items (e.g. generated by enclosed
                        // expressions) are
                            ...
                            if (textAccumulator != null) {
                                ...
                                content.add(
                                        ItemFactory.getInstance()
                                                .createXmlTextNode(textAccumulator.toString()));
            ...
            if (textAccumulator != null) {
                hasSeenNonAttributeNode = true;
                content.add(
                        ItemFactory.getInstance().createXmlTextNode(textAccumulator.toString()));
            }
        }
        // process namespace declaration attributes (they create namespace nodes, not attribute
        // nodes)
        ...
        ElementItem elementItem =
                (ElementItem)
                        ItemFactory.getInstance()
                                .createXmlElementNode(this.elementName, content, attributes);
    ...
    private static List<RuntimeIterator> createChildList(
            List<RuntimeIterator> content, List<AttributeNodeRuntimeIterator> attributes) {
