...
/**
 * Unary lookup for XQuery 3.1 only. Array index out of bounds yields err:FOAY0001 per XPath and XQuery Functions 3.1.
 */
public class XQueryUnaryLookupIterator extends LocalRuntimeIterator {
    ...
    public XQueryUnaryLookupIterator(
