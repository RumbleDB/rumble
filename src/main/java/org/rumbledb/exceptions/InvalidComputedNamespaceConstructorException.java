...
/**
 * Exception for XQDY0101: It is a dynamic error if a computed namespace constructor attempts to do
 * any of the following:
 *
 * <ul>
 *   <li>Bind the prefix xml to some namespace URI other than http://www.w3.org/XML/1998/namespace
 *   <li>Bind a prefix other than xml to the namespace URI http://www.w3.org/XML/1998/namespace
 *   <li>Bind the prefix xmlns to any namespace URI
 *   <li>Bind a prefix to the namespace URI http://www.w3.org/2000/xmlns/
 *   <li>Bind any prefix (including the empty prefix) to a zero-length namespace URI
 * </ul>
 *
...
public class InvalidComputedNamespaceConstructorException extends RumbleException {
    ...
    public InvalidComputedNamespaceConstructorException(
