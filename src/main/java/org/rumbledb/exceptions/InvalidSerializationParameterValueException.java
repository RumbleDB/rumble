 ...
 *
 * @see <a href="https://www.w3.org/TR/xslt-xquery-serialization-31/#ERRSEPM0016">XSLT/XQuery
 *     Serialization 3.1, C: SEPM0016</a>
 */
public class InvalidSerializationParameterValueException extends RumbleException {
    ...
    public InvalidSerializationParameterValueException(
            String parameterName, String value, String expectedValue) {
        super(
                "The value for the serialization parameter "
                        + parameterName
                        + " must be "
