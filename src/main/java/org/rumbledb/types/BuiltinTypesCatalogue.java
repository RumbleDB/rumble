...
public class BuiltinTypesCatalogue {
    public static final ItemType item =
            new ItemItemType(Name.createVariableInDefaultTypeNamespace("item"));

    public static final ItemType atomicItem =
            new AtomicItemType(new Name(Name.XS_NS, "xs", "anyAtomicType"), Collections.emptySet());
    public static final ItemType errorItem = new ErrorItemType();
    public static final ItemType stringItem =
            new AtomicItemType(
    ...
    public static final ItemType untypedAtomicItem =
            new AtomicItemType(
    ...
    public static final ItemType decimalItem =
            new AtomicItemType(
    ...
    public static final ItemType doubleItem =
            new AtomicItemType(
                    ...
                    java.util.Arrays.asList(
                            ...
                            "-INF",
                            "NaN"));
    public static final ItemType floatItem =
            new AtomicItemType(
    ...
    public static final ItemType numericItem =
            new UnionItemType(
    ...
    public static final ItemType booleanItem =
            new AtomicItemType(
    ...
    public static final ItemType nullItem =
            new AtomicItemType(new Name(Name.JS_NS, "js", "null"), Collections.emptySet());
    ...
    public static final ItemType yearMonthDurationItem =
            new DerivedAtomicItemType(
                    new Name(Name.XS_NS, "xs", "yearMonthDuration"),
                    durationItem,
                    durationItem,
                    Facets.createPatternFacets(Collections.singletonList("[^DT]*")),
                    false);
    public static final ItemType dayTimeDurationItem =
            new DerivedAtomicItemType(
                    ...
                    false);
    public static final ItemType dateTimeItem =
            new AtomicItemType(
    ...
    public static final ItemType dateTimeStampItem =
            new DerivedAtomicItemType(
    ...
    public static final ItemType timeItem =
            new AtomicItemType(
    ...
    public static final ItemType gDayItem =
            new AtomicItemType(
                    ...
                    CardinalityFacetValue.COUNTABLY_INFINITE,
                    false,
                    java.util.Collections.singletonList("---[0-9]{2}(Z|[+-][0-9]{2}:[0-9]{2})?"));
    public static final ItemType gMonthItem =
            new AtomicItemType(
                    ...
                    false,
                    java.util.Collections.singletonList("--[0-9]{2}(Z|[+-][0-9]{2}:[0-9]{2})?"));
    public static final ItemType gYearItem =
            new AtomicItemType(
                    ...
                    CardinalityFacetValue.COUNTABLY_INFINITE,
                    false,
                    java.util.Collections.singletonList("-?[0-9]{4,}(Z|[+-][0-9]{2}:[0-9]{2})?"));
    public static final ItemType gMonthDayItem =
            new AtomicItemType(
    ...
    public static final ItemType gYearMonthItem =
            new AtomicItemType(
    ...
    public static final ItemType hexBinaryItem =
            new AtomicItemType(
    ...
    public static final ItemType anyURIItem =
            new AtomicItemType(
                    ...
                    false,
                    null);
    public static final ItemType base64BinaryItem =
            new AtomicItemType(
    ...
    public static final ItemType QNameItem =
            new AtomicItemType(
    ...
    public static final ItemType NOTATIONItem =
            new AtomicItemType(
    ...
    public static final ItemType normalizedStringItem =
            new DerivedAtomicItemType(
    ...
    public static final ItemType tokenItem =
            new DerivedAtomicItemType(
    ...
    public static final ItemType languageItem =
            new DerivedAtomicItemType(
                    new Name(Name.XS_NS, "xs", "language"),
                    tokenItem,
                    stringItem,
                    Facets.createPatternFacets(
                            Collections.singletonList("[a-zA-Z]{1,8}(-[a-zA-Z0-9]{1,8})*")),
                    false);

    public static final ItemType NMTOKENItem =
            new DerivedAtomicItemType(
    ...
    public static final ItemType NameItem =
            new DerivedAtomicItemType(
    ...
    public static final ItemType NCNameItem =
            new DerivedAtomicItemType(
    ...
    public static final ItemType IDItem =
            new DerivedAtomicItemType(
    ...
    public static final ItemType IDREFItem =
            new DerivedAtomicItemType(
    ...
    public static final ItemType ENTITYItem =
            new DerivedAtomicItemType(
    ...
    public static final ItemType integerItem =
            new DerivedAtomicItemType(
    ...
    public static final ItemType longItem =
            new DerivedAtomicItemType(
    ...
    public static final ItemType intItem =
            new DerivedAtomicItemType(
                    new Name(Name.XS_NS, "xs", "int"),
                    longItem,
                    decimalItem,
                    Facets.createMinMaxFacets(
                            new IntItem(-2147483648), new IntItem(2147483647), true),
                    false);

    public static final ItemType shortItem =
            new DerivedAtomicItemType(
    ...
    public static final DerivedAtomicItemType byteItem =
            new DerivedAtomicItemType(
    ...
    public static final DerivedAtomicItemType nonNegativeIntegerItem =
            new DerivedAtomicItemType(
                    new Name(Name.XS_NS, "xs", "nonNegativeInteger"),
                    integerItem,
                    decimalItem,
                    Facets.createMinFacets(new IntegerItem(new BigInteger("0")), true),
                    false);

    public static final DerivedAtomicItemType nonPositiveIntegerItem =
            new DerivedAtomicItemType(
                    new Name(Name.XS_NS, "xs", "nonPositiveInteger"),
                    integerItem,
                    decimalItem,
                    Facets.createMaxFacets(new IntegerItem(new BigInteger("0")), true),
                    false);

    public static final DerivedAtomicItemType negativeIntegerItem =
            new DerivedAtomicItemType(
                    new Name(Name.XS_NS, "xs", "negativeInteger"),
                    nonPositiveIntegerItem,
                    decimalItem,
                    Facets.createMaxFacets(new IntegerItem(new BigInteger("-1")), true),
                    false);

    public static final DerivedAtomicItemType positiveIntegerItem =
            new DerivedAtomicItemType(
                    new Name(Name.XS_NS, "xs", "positiveInteger"),
                    nonNegativeIntegerItem,
                    decimalItem,
                    Facets.createMinFacets(new IntegerItem(new BigInteger("1")), true),
                    false);

    public static final DerivedAtomicItemType unsignedLongItem =
            new DerivedAtomicItemType(
    ...
    public static final DerivedAtomicItemType unsignedIntItem =
            new DerivedAtomicItemType(
    ...
    public static final DerivedAtomicItemType unsignedShortItem =
            new DerivedAtomicItemType(
    ...
    public static final DerivedAtomicItemType unsignedByteItem =
            new DerivedAtomicItemType(
    ...
    public static final ItemType commentNode =
            new XmlNodeItemType(Name.createVariableInDefaultTypeNamespace("comment"));
    public static final ItemType textNode =
            new XmlNodeItemType(Name.createVariableInDefaultTypeNamespace("text"));
    public static final ItemType namespaceNode =
            new XmlNodeItemType(Name.createVariableInDefaultTypeNamespace("namespace-node"));
    ...
    public static final ItemType objectItem =
            new ObjectItemType(
                    ...
                    Collections.emptyList(),
                    null);
    public static final ItemType arrayItem =
            new ArrayItemType(
    ...
    public static final ItemType mapItem =
            new MapItemType(
                    Name.createVariableInDefaultTypeNamespace("map"),
                    anyFunctionItem,
                    atomicItem,
                    SequenceType.createSequenceType("item*"));
    public static final ItemType xqueryArrayItem =
            new XQueryArrayItemType(
    ...
    private static final List<ItemType> builtInItemTypes =
            Arrays.asList(
                    nodeItem,
                    elementNode,
                    attributeNode,
    ...
    public static ItemType getItemTypeByName(Name name) {
        ...
        throw new OurBadException(
                "Type unrecognized: " + name + "(namespace: " + name.getNamespace() + ")");
    }
}
