...
public class SequenceType implements Serializable {
    ...
    static {
        ...
        sequenceTypes.put("numeric", new SequenceType(BuiltinTypesCatalogue.numericItem, SequenceType.Arity.One));
        sequenceTypes.put("numeric?", new SequenceType(BuiltinTypesCatalogue.numericItem, SequenceType.Arity.OneOrZero));
