...
public class SequenceType implements Serializable {
    ...
    static {
        ...
        sequenceTypes.put("gMonthDay?", new SequenceType(BuiltinTypesCatalogue.gMonthDayItem, SequenceType.Arity.OneOrZero));
        sequenceTypes.put("gYearMonth?", new SequenceType(BuiltinTypesCatalogue.gYearMonthItem, SequenceType.Arity.OneOrZero));
