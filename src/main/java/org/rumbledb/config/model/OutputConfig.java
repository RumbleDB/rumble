...
public class OutputConfig implements Serializable {
    ...
    @Default int numberOfOutputPartitions = DEFAULT_NUMBER_OF_OUTPUT_PARTITIONS;
    ...
    @Default boolean allowOverwrite = false;

    /**
     * Options to further specify the output format, for example a separator character for CSV or a
     * compression format.
     */
