...
public final class RuntimeArguments {
    ...
    @Option(
            ...
            negatable = true,
            description =
                    "Activates DataFrame execution mode detection for higher-order functions.")
    ...
    public RuntimeConfig toConfig() {
        ...
        OptionConversion.applyBooleanIfPresent(
                this.nativeSQLPredicates, builder::useNativeSQLPredicates);
        OptionConversion.applyBooleanIfPresent(
                this.dataFrameExecutionModeDetection, builder::detectDataFrameExecutionMode);
        OptionConversion.applyBooleanIfPresent(
                this.parallelExecution, builder::useParallelExecution);
        OptionConversion.applyBooleanIfPresent(
                this.dataFrameExecution, builder::useDataFrameExecution);
