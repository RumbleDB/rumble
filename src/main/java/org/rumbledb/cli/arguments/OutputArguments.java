...
public final class OutputArguments {
    ...
    @Option(
            names = "--log-path",
            paramLabel = "path",
            description = "Where to output log information.")
    ...
    @Option(
            ...
            paramLabel = "command",
            description =
                    "Post-processes the output of JSONiq queries on the shell with the specified command.")
    ...
    public OutputConfig toConfig() {
        ...
        OptionConversion.applyIntIfPresent(
                this.numberOfOutputPartitions, builder::numberOfOutputPartitions);
        ...
        OptionConversion.applyIfPresent(
                ...
                options ->
                        builder.serializationParameters(
                                SerializationParameterBuilder.build(options)));
