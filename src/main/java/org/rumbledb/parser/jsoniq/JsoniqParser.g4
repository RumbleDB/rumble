...
/*
    Mostly taken from http://www.w3.org/TR/xquery/#id-grammar, with some simplications:CHANNELS
...
typeDecl
   : KW_DECLARE KW_TYPE type_name = qname KW_AS (schema = schemaLanguage)? type_definition = exprSingle
   ;
