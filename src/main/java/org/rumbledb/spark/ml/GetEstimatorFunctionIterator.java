...
public class GetEstimatorFunctionIterator extends AbstractAtMostOneItemRuntimePlan {
    ...
    public static final List<Name> estimatorFunctionParameterNames = new ArrayList<>(Arrays.asList(
            Name.createVariableInDefaultFunctionNamespace("estimator-input-f6c87df3-fcba-47c7-a5ff-a1a7553b1cab"),
            Name.createVariableInDefaultFunctionNamespace(
                    "estimator-paramobject-ded8adb9-df6f-42b2-b493-863a421a2754")));

    public GetEstimatorFunctionIterator(List<ItemRuntimePlan> arguments, RuntimeStaticContext staticContext) {
    ...
    public Item evaluateAtMostOne(DynamicContext dynamicContext) {
        ...
        try {
            ...
            ItemRuntimePlan bodyIterator = new ApplyEstimatorRuntimeIterator(
                    estimatorShortName,
                    estimator,
            ...
            List<SequenceType> paramTypes = Collections.unmodifiableList(Arrays.asList(
                    SequenceType.createSequenceType("object*"), SequenceType.createSequenceType("object")));
            SequenceType returnType = SequenceType.createSequenceType("function(object*, object) as object*");

            return new FunctionItem(
                    new FunctionIdentifier(
                            Name.createVariableInDefaultFunctionNamespace(estimatorSparkMLClass.getName()), 2),
