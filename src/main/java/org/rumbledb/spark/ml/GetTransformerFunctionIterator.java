...
public class GetTransformerFunctionIterator extends AbstractAtMostOneItemRuntimePlan {
    ...
    public static final List<Name> transformerParameterNames = new ArrayList<>(Arrays.asList(
            Name.createVariableInDefaultFunctionNamespace("transformer-input-9470aa1b-13cb-405b-b598-910cb2d18224"),
            Name.createVariableInDefaultFunctionNamespace(
                    "transformer-paramobject-e05c895c-be12-4df1-8a86-8b90f10a7129")));

    public GetTransformerFunctionIterator(List<ItemRuntimePlan> arguments, RuntimeStaticContext staticContext) {
    ...
    public Item evaluateAtMostOne(DynamicContext dynamicContext) {
        ...
        try {
            ...
            throw new OurBadException(transformerShortName
                    + ": we could not find any transformer with that name. Please check the documentation.");
        }

        try {
            Transformer transformer = (Transformer)
                    transformerSparkMLClass.getDeclaredConstructor().newInstance();
            ...
            return new FunctionItem(
                    new FunctionIdentifier(
                            Name.createVariableInDefaultFunctionNamespace(transformerSparkMLClass.getName()), 2),
