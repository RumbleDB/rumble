...
public class BinaryClassificationMetricsFunctionIterator extends AtMostOneItemLocalRuntimeIterator {
    ...
    public Item materializeFirstItemOrNull(DynamicContext context) {
        ...
        objectItem.putItemByKey(
                "areaUnderPR", ItemFactory.getInstance().createDoubleItem(bcm.areaUnderPR()));
        objectItem.putItemByKey(
                "areaUnderROC", ItemFactory.getInstance().createDoubleItem(bcm.areaUnderROC()));
        ...
        RuntimeIterator it = new ConstantRDDRuntimeIterator(rdd, staticContext);
    ...
    private JavaRDD<Item> tupleToArrays(
            JavaRDD<Tuple2<Object, Object>> pr1, String key1, String key2) {
        return pr1.map(
                new Function<Tuple2<Object, Object>, Item>() {
                    ...
                    public Item call(Tuple2<Object, Object> a) {
                        ...
                        return ItemFactory.getInstance()
                                .createObjectItem(
                                        keys, values, ExceptionMetadata.EMPTY_METADATA, true);
                    }
                });
    }
}
